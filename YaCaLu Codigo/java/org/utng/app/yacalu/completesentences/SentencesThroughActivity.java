...
public class SentencesThroughActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sentences_through);
        ...
        btnCheck.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(etSquare.getText().toString().toLowerCase().equals("through")){
        ...
        btnNxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (v.getContext(), SentencesNextToActivity.class);
