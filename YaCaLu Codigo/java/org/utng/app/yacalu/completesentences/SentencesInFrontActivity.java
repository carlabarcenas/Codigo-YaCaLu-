...
public class SentencesInFrontActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sentences_in_front);
       ...
       btnNxt = (Button) findViewById(R.id.btn_nxt);
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                etSquare = (EditText) findViewById(R.id.edit_complete);

                if (etSquare.getText().toString().toLowerCase().equals("in front of")) {
                    tvAsware.setText(R.string.respco);
        ...
        btnNxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (v.getContext(), SentencesOnActivity.class);
